...
export const DateTimeStep: React.FC<DateTimeStepProps> = ({
  ...
  return (
    <AnimatedContainer animation="fadeIn" duration={0.3}>
       <div data-testid="datetime-step" data-barber-id={barberId} data-max-days={maxAdvanceDays} className="min-w-0 p-3 sm:p-6">
         <div className="grid min-w-0 gap-3 md:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] md:items-stretch">
