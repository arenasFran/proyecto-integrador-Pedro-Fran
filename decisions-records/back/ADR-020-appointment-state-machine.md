...
- Admin/Empleado puede usar `PATCH /:id/pay` para marcar como pagado manualmente
...
| Clase Finite State Machine completa | No implementado; la validación sigue en el use case |
...
- **Negativo**: La máquina de estados y los métodos de la entidad (`cancel()`, `complete()`, `markNoShow()`) no son usados por los casos de uso (actualizan vía repositorio directamente)

## Estado

Aceptada — actualizada 2026-06-10.
