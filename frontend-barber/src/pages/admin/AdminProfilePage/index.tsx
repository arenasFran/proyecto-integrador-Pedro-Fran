...
export const AdminProfilePage: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      await dispatch(updateBarber({ id: formData._id, data: updatePayload })).unwrap();
      await dispatch(updateBarberSchedule({ id: formData._id, schedule: scheduleFromForm(schedule) })).unwrap();
